...
public class SmsSendUtil {
	...
	static final String accessKeyId = PropertiesUtil.getProperty("accessKeyId");
	static final String accessKeySecret = PropertiesUtil.getProperty("accessKeySecret");
	...
	public static SendSmsResponse sendSms(String code, String phone) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName(PropertiesUtil.getProperty("signName"));
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode(PropertiesUtil.getProperty("templateCode"));
	...
	public static String resetPassword(String phone) throws ClientException{
