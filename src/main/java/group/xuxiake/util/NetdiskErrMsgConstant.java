...
public class NetdiskErrMsgConstant {
	...
	/*登录-用户重复登录*/
	public static final int LOGIN_USER_REPEAT_LOGIN_ERR = 20013;
	/*登录-登录失败*/
	public static final int LOGIN_FAILED = 20014;
	/*获取用户信息-登录过期*/
	public static final int GET_INFO_SESSION_TIME_OUT = 20014;
